...
* The design intent of a sealed class is to indicate that the class is specialized
* and there is no need to extend it to provide any additional functionality
* through inheritance to override its behavior.*/
